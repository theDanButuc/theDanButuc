...
- Docker
- Docker Compose
- Kubernetes (Minikube, fundamentals)
...
- Production-oriented retouching pipelines

**Automation**
- Photoshop automation using:
  - JavaScript (ExtendScript)
  - AppleScript
  - Python
- Workflow optimization for creative teams

**Training (Planned)**
- Upcoming **Photoshop Training Sessions**
- Focus on:
...
- Claude Code (AI-assisted development & automation)
